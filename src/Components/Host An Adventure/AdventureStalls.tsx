            ...
            <div className="min-frame-height host-exp">
                ...
                <div >
                    <div className="container py-3 mb-4">
                        ...
                        <div className="text-center mt-5">
                            <Link to="/add-experience/step1">
                                <button className="btn-primary-outline-lg" tabIndex={0} >Start creating your adventure</button>
                            </Link>
                        </div>
                    </div>
                </div>
                <div className="host-exp-bg">
                    <div className="col-md-6 px-md-0 text-center">
                        ...
                        <Link to="/add-experience/step1">
                            <button className="btn btn-outline-light px-3 py-2">Let’s go</button>
                        </Link>
                    </div>
                </div>
            </div>
