...
import GuestPublish from "./Components/Host Guests/GuestPublish";
      ...
      <Router>
        <Routes>
          <Route path="*" element={<Components />}>
            ...
            <Route path="create-stall/checkin-and-checkout/:id" element={<Stalls9 setSteps={setSteps} steps={steps} />} />
            ...
            <Route path="create-guest/checkin-and-checkout/:id" element={<GuestStep9 steps={steps} setSteps={setSteps} />} />
